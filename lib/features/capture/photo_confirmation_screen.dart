...
class ProcessingPlaceholderScreen extends StatelessWidget {
  const ProcessingPlaceholderScreen({super.key});
          ...
          child: Stack(
            children: <Widget>[
              Positioned(
                ...
                top: 16,
                child: IconButton(
                  key: const ValueKey<String>('processing-placeholder-back'),
                  tooltip: '返回',
              ...
              const Center(
                child: Column(
                  key: ValueKey<String>('processing-placeholder'),
                  mainAxisSize: MainAxisSize.min,
                  children: <Widget>[
                    Text(
                      'AI 生成',
